...
@DatasetReader.register("squad_qa")
class SquadQAReader(DatasetReader):
    """
    !!! Note
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._tokenizer = tokenizer or SpacyQATokenizer()
...
DatasetReader.register("squad1_qa", constructor="squad1")(SquadQAReader)
DatasetReader.register("squad2_qa", constructor="squad2")(SquadQAReader)
